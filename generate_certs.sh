...
CLIENT_A_SUBJECT="${CLIENT_A_SUBJECT:-/CN=jsgNdfa}"
CLIENT_B_SUBJECT="${CLIENT_B_SUBJECT:-/CN=hpknclS}"

CLIENT_A_PASSPHRASE="${CLIENT_A_PASSPHRASE:-love22}"
CLIENT_B_PASSPHRASE="${CLIENT_B_PASSPHRASE:-love33}"
